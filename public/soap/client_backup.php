<!-- <div class="note">
            <strong>Catatan:</strong> Client ini menggunakan mode WSDL untuk berkomunikasi dengan server SOAP. 
            Pastikan file WSDL tersedia di <code>http://localhost/contact-api/public/soap/contact.wsdl</code>.
            <br>
            <strong>Alur penggunaan yang benar:</strong>
            <ol>
                <li>Buat User terlebih dahulu (tab User Operations)</li>
                <li>Gunakan ID User untuk membuat Contact (tab Contact Operations)</li>
                <li>Gunakan ID Contact untuk membuat Address (tab Address Operations)</li>
            </ol>
        </div> -->
